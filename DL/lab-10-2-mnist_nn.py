...
Y = tf.placeholder(tf.float32, [None, 10], name= 'X')   # add name by sckim
...
print(">> Get one and predict : ", datetime.datetime.now())
# Get one and predict
...
# 학습 데이터(그래프 각 변수) 저장
###############################################################################
model_save_dir = "./model_save_dir/minist/10-2/nn"
